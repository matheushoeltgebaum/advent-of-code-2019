const checkAdjacency = function (firstNumber, secondNumber, thirdNumber, fourthNumber, fifthNumber, sixthNumber) {
    return (
        ...
        (firstNumber !== secondNumber && secondNumber === thirdNumber && thirdNumber !== fourthNumber) ||
        (secondNumber !== thirdNumber && thirdNumber === fourthNumber && fourthNumber !== fifthNumber) ||
        (thirdNumber !== fourthNumber && fourthNumber === fifthNumber && fifthNumber !== sixthNumber) ||
        (fourthNumber !== fifthNumber && fifthNumber === sixthNumber)
    );
}
